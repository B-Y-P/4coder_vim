...
#define MAP 0
  ...
  /// Window Binds
  VimBind(N|MAP, vim_change_x0, (Ctl|KeyCode_H));
  VimBind(N|MAP, vim_change_y1, (Ctl|KeyCode_J));
  VimBind(N|MAP, vim_change_y0, (Ctl|KeyCode_K));
  VimBind(N|MAP, vim_change_x1, (Ctl|KeyCode_L));
